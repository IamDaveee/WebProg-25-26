...
let i=0;
for (const element of fejlec) {
    carousel+=`<li data-target="#diasor" data-slide-to="${i}" class="${i==0?"active":""}"></li>`
...
const slideShow = document.getElementById("diasor").firstElementChild.innerHTML+=carousel

const second=document.getElementById("diasor").children[1].innerHTML+=carouselItem
